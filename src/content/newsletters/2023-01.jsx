...
export default function Issue() {
	return (
		<>
			...
			<h3 className="mb-3 fst-italic">
				January -&gt;{' '}
				<Link href="/monthlychallenges/jan-2023">Month of Learning</Link>!
			</h3>
			<p>
			...
			<p>
				...
				<Link href="/monthlychallenges/jan-2023">Virtual Coffee website</Link>{' '}
				for more details!
			</p>
