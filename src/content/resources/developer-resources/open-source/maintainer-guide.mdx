...
- **Community documentation** <br />
  It explains how the community works and where to search for things related to the community. For example, we have our{' '} <Link href="/resources/virtual-coffee-handbook/">Virtual Coffee Handbook</Link> at Virtual Coffee.
