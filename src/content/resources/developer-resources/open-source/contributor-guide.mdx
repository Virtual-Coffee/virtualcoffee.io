...
It is not advised to work on a project that doesn't have a license or is not using a standard open source license. Check out <Link href="/resources/developer-resources/open-source/maintainer-guide#the-license">The License</Link> section of our Maintainer Guide for resources about licenses.
