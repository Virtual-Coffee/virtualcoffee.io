...
Creating content about code, your journey into code, or anything else? This channel is to support, offer feedback, and check out what you’ve created. It can be written, audio, video, or anything else!
...
Backend shenanigans channel! Node, spring, aspnet, Django, rails, the works!
...
This channel is for all your MERN, MEAN, PERN, t3.gg, Spring/Hibernate, ASPNET/Entity, full-stack fun!
