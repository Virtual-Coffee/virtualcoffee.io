...
export const Shubham404: MemberObject = {
    ...
    bio: `Enthusiastic ML engineer and developer.`,
    //
    ...
    accounts: [
        { type: 'linkedin', username: 'shubham-404-' },
        ...
        { type: 'medium', username: 'Shubham-404' },
        // { type: 'hashnode', username: 'yourUserName' },
        // { type: 'mastodon', url: 'https://mastodon.server/@username' },
        { type: 'website', url: 'https://shubham-404.github.io/Portfolio/', title: 'Portfolio Website' },
    ],
    badges: [],
    ...
    location: {
    	latitude: 22.171841,
    	longitude: 22.171841,
    	title: 'Prayagraj, India', // optional
    },
};
