...
export const rainwithcode: MemberObject = {
	...
	mainUrl: 'https://rainwithcode.com',
	//
	...
	bio: `Inclusive Tech | Front-end Developer | #Dyspraxic | Filipina


[rainwithcode.com](https://rainwithcode.com)
    `,
	//
	...
	accounts: [
		{ type: 'linkedin', username: 'rain-kalugdan' },
		...
		{
			type: 'website',
			url: 'https://www.rainwithcode.com/',
			title: 'Rain With Code Portfolio',
		},
	],
	badges: [],
	location: {
