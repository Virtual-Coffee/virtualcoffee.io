...
export const alanacapcreates: MemberObject = {
	// GitHub username (required)
	github: 'alanacapcreates',
	//
	...
	mainUrl: 'https://github.com/alanacapcreates',
	//
	...
	bio: `Frontend Developer from Long Island, NY`,
	//
	...
	accounts: [
		{ type: 'linkedin', username: 'alanacaporale' },
		...
		{ type: 'website', url: 'https://alanacapcreates.com', title: 'Portfolio' },
	],
	badges: [],
