...
export const handle = {
	...
	meta: {
		title:
			'Monthly Theme & Challenge for August, 2021: Healthy Habits for Healthy Devs',
		description:
...
export default function Challenge() {
	return (
		<>
			...
			<h1>
				<small>Monthly Challenge for August, 2021:</small>
			...
			<h3>Tips for form healthy habits</h3>
			<ul>
				<li>
