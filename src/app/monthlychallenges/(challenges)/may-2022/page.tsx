...
export default function Challenge() {
	return (
		<>
			...
			<p className="lead">
				It's amazing to realize that we've made it through more than 200 Coffees
				and more than two years of Virtual Coffee! As we work hard to make sure
				this community continues to be the special and close-knit group that it
				has been during that time, let's celebrate one of the things that
				continually makes this community so special: Kindness.
			</p>
			...
			<ul>
				...
				<li>
					Use another social media platform, like Twitter, to offer gratitude,
