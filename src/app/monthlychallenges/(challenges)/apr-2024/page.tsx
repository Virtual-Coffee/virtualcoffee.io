...
export const handle = {
	listTitle: 'April, 2024: Find Your Voice! Public Speaking',
	meta: {
		title: 'Monthly Challenge for April 2024: Find Your Voice! Public Speaking',
		description:
	...
	return (
		<>
			<div className="alert alert-success">
				...
				the <Link href="/monthlychallenges/may-2024">next challenge</Link>!
			</div>
			<h1>
			...
			<ul>
				<li>
					We're dedicating this month to becoming confident public speakers.
					Whether you're gearing up for a conference, a local meetup, or just
					want to improve, now is the perfect time with the support of our
					community.
				</li>
				<li>
				...
				<li>
					Keep in mind that different experiences will have different
					approaches, but we can all provide constructive feedback.
				</li>
			</ul>
			<p className="lead">
				<strong>
					We're breaking this challenge into weeks, but feel free to focus on
			...
			<ul>
				<li>
					<strong>Challenge</strong>: Identify and challenge negative thoughts
					about public speaking.
				</li>
				<li>
					<strong>Activity</strong>: Record yourself delivering a short
					introduction and watch it back to identify areas for improvement
					(optional).
				</li>
			</ul>
			...
			<ul>
				<li>
					<strong>Step one</strong>: Create a list of 5-10 topics you're
					passionate about or that you want to learn more about.
				</li>
				<li>
					<strong>Step two</strong>: Create a rough outline of 2-3 from the
					list.
				</li>
			</ul>
			...
			<ul>
				<li>
					<strong>Challenge</strong>: Finalize your topic and develop a clear,
					concise message.
				</li>
				<li>
					<strong>Activity</strong>: Draft an outline for your talk, including
			...
			<ul>
				<li>
					<strong>Challenge</strong>: Work on your vocal delivery, body
					language, and use of visuals.
				</li>
				<li>
					<strong>Activity</strong>: Practice delivering your presentation in
					front of a mirror or someone else.Refine your presentation based on
					the feedback received and practice delivering it confidently.
				</li>
			</ul>
			<h3>Week Four: Final Preparation and Presentation</h3>
			<ul>
				<li>
					<strong>Challenge</strong>: Make your final preparations and any
			...
			<ul>
				<li>
					<a href="https://www.toastmasters.org/">Toastmasters</a>
				</li>
				<li>
