...
Many employers value open source work in tech. You should make space for your contributions list on your resume, especially if you are looking for your first developer job. It will help you stand out from other candidates.
...
<dl>
	...
	<dd>A guide for you to contribute to an open source project.</dd>
	{/* prettier-ignore */}
	<dt><Link to="/resources/developer-resources/open-source/maintainer-guide">Maintainer Guide</Link></dt>
	{/* prettier-ignore */}
	<dd>A guide for you to maintain your open source project for the first time.</dd>
</dl>
...
- Distributed Autonomous Organizations (DAOs) are becoming popular in the blockchain and cryptocurrency space. While the details differ from project to project, these will typically feature a governance token on a blockchain that can be transferred or bought and sold. The holders are allowed to vote on proposals.
