...
<dl>
	{/* prettier-ignore */}
	<dt><Link to="/resources/developer-resources/open-source/contributor-guide">Contributor Guide</Link></dt>
	<dd>A guide to contributing to an open source project.</dd>
	{/* prettier-ignore */}
	<dt><Link to="/resources/developer-resources/open-source/maintainer-guide">Maintainer Guide</Link></dt>
	{/* prettier-ignore */}
