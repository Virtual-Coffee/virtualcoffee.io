...
- <Link to="/resources/developer-resources/open-source/contributor-guide">Contributor Guide</Link> if you want to contribute to an open source project.
- <Link to="/resources/developer-resources/open-source/maintainer-guide">Maintainer Guide</Link> if you're going to maintain your open source project.
