...
2. In the local environment
   ...
   - Do all the steps in <Link to="/resources/developer-resources/open-source/git-101#fetching-upstream-changes">Fetching `upstream` Changes</Link> and <Link to="/resources/developer-resources/open-source/git-101#synchronizing-changes-locally">Synchronizing Changes Locally</Link> sections.<br />  
