...
Check our complete channel list on the <Link to="/resources/virtual-coffee-handbook/guides-to-virtual-coffee/slack-channels-guide">Virtual Coffee Slack Channels Guide</Link> page.
...
- [How to be great at asking coding questions — Gordon Zhu](https://medium.com/@gordon_zhu/how-to-be-great-at-asking-questions-e37be04d0603)
