...
meta:
  ...
  description: Things happen in Virtual Coffee (with how-to instructions).
hero:
...
When we move to the small group conversations, there will be a <Link to="/resources/virtual-coffee-handbook/guides-to-virtual-coffee/glossary#room-leader">Room Leader</Link> and <Link to="/resources/virtual-coffee-handbook/guides-to-virtual-coffee/glossary#note-taker">Note Taker</Link> for the room. They'll explain how we do introductions and how to participate. We value our members and the ways they're most comfortable participating.
...
Do you want to work or learn with people around, need help and a pair program, or only want to hang out with other members? Thanks to **Dan Ott**, we have a `#co-working-room` channel linked to our Zoom, so our members can connect anytime! It's open 24/7!
...
You can find the complete schedule of the events on the <Link to="/events">Events</Link> page.
...
When you need to share code snippets in your message, you want to ensure it's well-formatted to make it readable and easy to understand.
