...
Every month, we create a challenge to provide members the opportunity to learn, grow, and receive support and mentorship. Each month's challenge will have a theme and weekly goals for the members to work on. Our Challenge Team and our Maintainers plan, organize, and facilitate these challenges. Go to the <Link to="/monthlychallenges">Virtual Coffee Monthly Challenges</Link> page to see our challenges.
