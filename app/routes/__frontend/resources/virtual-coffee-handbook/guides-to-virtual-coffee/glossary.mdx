...
An event where we encourage, help, and support our members to contribute to and/or maintain open source repositories during <Link to="/resources/virtual-coffee-handbook/guides-to-virtual-coffee/glossary#hacktoberfest">Hacktoberfest</Link>.
