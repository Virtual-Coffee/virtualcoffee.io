...
**Leaders: Julia Seidman and Marie Antons**
...
**Leaders: Meg Gutshall, Lillian Chan, Sadie Jay, and Raynald Mirville**
...
- If you'd like to start a new Coffee Table Group, head to the <Link to="/resources/virtual-coffee-handbook/get-involved/leading-coffee-table-groups">Leading a Coffee Table Group page</Link> for more information.
