...
- Events appear in announcements and on the <Link to="/events">Virtual Coffee events page</Link>.
...
- Type of meeting (Q&A, presentation, small group convo, pair programming, interactive, etc.).
