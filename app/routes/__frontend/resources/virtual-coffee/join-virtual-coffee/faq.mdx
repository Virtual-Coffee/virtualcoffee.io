...
You need to attend one of our <Link to="/resources/virtual-coffee/guide-to-virtual-coffee/what-to-expect-in-virtual-coffee#coffees-zoom-meetings">Coffees (Zoom Meetings)</Link> on **Tuesday at 9:00 AM ET** or **Thursday at 12:00 PM ET** that last an hour.
...
See the "<Link to="/resources/virtual-coffee/guide-to-virtual-coffee/what-to-expect-in-virtual-coffee">What To Expect In Virtual Coffee</Link>" page for more insights.
