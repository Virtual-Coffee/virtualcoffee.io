...
You need to attend one of our <Link to="/resources/virtual-coffee/virtual-coffee-handbook/what-to-expect-in-virtual-coffee#coffees-zoom-meetings">Coffees (Zoom Meetings)</Link> on **Tuesday at 9:00 AM ET** or **Thursday at 12:00 PM ET** that last an hour.
...
Check out our <Link to="/resources/virtual-coffee/virtual-coffee-handbook/">Virtual Coffee Handbook</Link> for more details.
...
You can participate in our <Link to="/events">events</Link>, have access to our Slack, get support and help as you need, mentorship, and most of all, FRIENDSHIPS!
Feel free to take a glimpse of <Link to="/resources/virtual-coffee/virtual-coffee-handbook/what-to-expect-in-virtual-coffee">what’s going on in Virtual Coffee</Link> to get some more insights.
