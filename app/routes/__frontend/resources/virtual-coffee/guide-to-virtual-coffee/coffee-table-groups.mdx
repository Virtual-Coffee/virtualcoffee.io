...
In this section, you will find the list of our current Coffee Table Groups based on the day and time of the events. You can contact the group's Leader for any questions or ask for more information, and you are most welcome to join!
...
__Leader: Kai Katschthaler(they/them)__

</LeadText>

A weekly Coffee Table Group for all trans, nonbinary, gender-divergent, and gender-questioning folks. We want to provide a safe space for trans vents, trans joy, and all trans-related topics on your mind. Share your experience, ask for advice, or just come to hang out with other non-cis folks for an hour. Trigger warnings before sharing about heavy topics are strongly encouraged! <br />
If you have any questions about whether this group is right for you, get in touch with the group's leader.
...
__Leaders: Julia Seidman and Marie Antons__
...
__Leaders: Meg Gutshall, Lillian Chan, Sadie Jay, and Raynald Mirville__

</LeadText>

You want to learn that new tool, finish that blog post, or send that job application, but you're so busy that the day is over before you know it. Join us and add some fun and friendly accountability to your schedule!
...
__Leaders: Jörn Bernhardt and Aishwarya Mali__

</LeadText>

We first started Frontend Friday Folks every Friday. But now, we also have a session on Saturdays! We work on a puzzle at [CSSBattle](https://cssbattle.dev/), and we're taking over the `#co-working-room` channel during this time. Feel free to join us and learn more about CSS!
...
__Leader: Tom Cudd__ <br />
_(or contact our <Link to="/resources/virtual-coffee/get-involved/paths-to-leadership#coffee-table-groups-coordinator">Coffee Table Group Coordinator</Link>, Abbey Perini)_
...
- If you'd like to start a new Coffee Table Group, head to the <Link to="/resources/virtual-coffee/get-involved/leading-coffee-table-groups">Leading a Coffee Table Group page</Link> for more information.
- If you want to help a particular Coffee Table Group, feel free to reach out to the group's Leader or our <Link to="/resources/virtual-coffee/get-involved/paths-to-leadership#coffee-table-groups-coordinator">Coffee Table Group Coordinator</Link>.
