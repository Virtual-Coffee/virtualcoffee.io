...
Our weekly Zoom meeting chats on Tuesdays at 9:00 AM ET and Thursdays at 12:00 PM ET.
...
Virtual Coffee's <Link to="https://virtualcoffee.io/members">core team</Link>.
...
We take the initiative to help and support our members to contribute to and/or maintain open sources during the <Link to="/resources/virtual-coffee/guide-to-virtual-coffee/glossary#hacktoberfest">Hacktoberfest</Link> event.
