...
After some pre-coffee chatter, our MC will do an intro with some background and important announcements while people filter in. Then we'll break the crowd into breakout rooms for more relaxed and intimate conversations.
