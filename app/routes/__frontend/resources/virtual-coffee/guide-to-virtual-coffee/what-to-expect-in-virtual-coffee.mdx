...
We get many questions like "What to expect once we join Virtual Coffee?" "Where's the link to today's Coffee?" "How to join a Virtual Coffee event?" "How to find, add or delete channels on Slack?" This section serves as a guide to answer these questions!
...
- <Link to="/resources/virtual-coffee/guide-to-virtual-coffee/coffee-table-groups">
  	Coffee Table Groups
  </Link>
- <Link to="/resources/virtual-coffee/get-involved/lunch-and-learns">
  	Lunch & Learns
  </Link>
- <Link to="/resources/virtual-coffee/guide-to-virtual-coffee/lightning-talk">
  	Lightning Talk
  </Link>
- <Link to="/resources/virtual-coffee/guide-to-virtual-coffee/monthly-challenges">
  	Monthly Challenges
  </Link>
- <Link to="/resources/virtual-coffee/guide-to-virtual-coffee/hacktoberfest-initiative">
...
See our <Link to="/resources/virtual-coffee/guide-to-virtual-coffee/slack-channel-guide">Virtual Coffee Slack Channel Guide</Link> for the complete list.
...
- Hover over to the "Channel" tab on the left side
- Click the "+" button
