...
meta:
  ...
  description: All the channels available in our community's Slack!
hero:
...
See the "Joining events" section in <Link to="/resources/virtual-coffee/guide-to-virtual-coffee/slack-channels-guide#vc-events">#vc-events</Link>.
...
This is a channel that has such a big energy! Drop by here if you want to give/get that motivation and big energy for/from others! 🔥
...
When you have questions or thoughts on career life — including company culture, navigating red tape, onboarding, etc., drop them in this channel!

---

### #career-management

The channel for managers to talk about management issues and sharing articles, also to ask for advice and tips about management.
...
A channel to ask questions or discuss anything related to DevOps and Cloud.
...
Do you want to discuss or have any questions around full-stack? Then you're looking at the right channel!
...
This is the place to discuss all things WordPress!
...
The floodgates are open to discuss any and all of our beloved entertainment. Musics, TV shows, movies, manga/anime, comics, Marvel, etc. As always, the Code of Conduct applies. No NSFW content.
...
Did you totally nailed the latest Noodle, Wordle, Hurdle, or Zoodle?!? Go you! 🎉 Share those results here, threading conversations as appropriate.
...
Place to go to talk about tech history.

---

### #vc-events

This channel is for announcements and discussions of official Virtual Coffee and member-led events open to Virtual Coffee members.
