...
Our members voluntarily hold events from members to members! We have <Link to="/resources/virtual-coffee/coffee-table-groups">Coffee Table Groups</Link>, <Link to="/resources/virtual-coffee/lunch-and-learns">Lunch & Learns</Link>, <Link to="/resources/virtual-coffee/lightning-talks">Lightning Talks</Link>, <Link to="/resources/virtual-coffee/monthly-challenges">Monthly Challenges</Link>, and <Link to="/resources/virtual-coffee/hacktoberfest">HacktoberFest</Link>.
