...
meta:
  ...
  description: Things that our members can expect happening in Virtual Coffee.
hero:
...
## What To Expect In Virtual Coffee (With How-To Handbook)

<LeadText>

We get lots of questions such as "What to expect once we joined Virtual Coffee?" "How to find, add or delete channels on Slack?" "Where's the link to the today's coffee Zoom?" "How to join a Virtual Coffee event?"
...
You can find the schedule of the events on the <Link to="/events">Events page</Link>.
