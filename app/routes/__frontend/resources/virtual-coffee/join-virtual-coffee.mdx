...
You need to attend one of our <Link to="/resources/virtual-coffee/guide-to-vc#coffees-zoom-meetings">Coffees (Zoom Meetings)</Link> on **Tuesday at 9:00 AM ET** or **Thursday at 12:00 PM ET** that last an hour.
...
Check out our <Link to="/resources/virtual-coffee/guide-to-vc/">Guide To Virtual Coffee</Link> for more details.
...
Feel free to take a glimpse of <Link to="/resources/virtual-coffee/guide-to-vc#what-to-expect-in-virtual-coffee">what’s going on in Virtual Coffee</Link> to get some more insights.
