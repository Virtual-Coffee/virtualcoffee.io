...
- [Contributor Guide](./contributor-guide) if you want to contribute to an open source project.
- [Maintainer Guide](./maintainer-guide) if you're going to maintain your open source project.
