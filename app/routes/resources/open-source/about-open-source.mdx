...
## Good to know: Funding, Governance and Building your Portfolio in Open Source:
...
Doing open source work is a great way to improve your skills, build your portfolio and get noitcied by others in the industry.

Working out how to get started can be the hardest part, so we've put together a list of resources to help you get going:

Virtual Coffee's own:
...
Recommended resources from outside Virtual Coffee:
...
If you know of resources we should add to this section, check out our [discussion](https://github.com/Virtual-Coffee/virtualcoffee.io/discussions/529)! We'd love to hear from you!

Open Source work is valued experience by many employers in tech, so you should definitely make space for your ontributions on your resume. Especially if you are looking for your first developer job, it will help you stand out from other candidates.

It is also worth remebering that contributing to Open Source does not require writing code. Improving documentation, working on marketing or community building or design or illustration contributions are equally valuable to projects.
