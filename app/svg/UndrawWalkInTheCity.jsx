export default function UndrawWalkInTheCity({
	ariaHidden,
	...
	return (
		<svg
			...
			{...(ariaHidden
				...
				: {
						role: 'img',
						'aria-labelledby': 'undrawWalkInSvgTitle',
				  })}
		>
			{!ariaHidden && (
				<title id="undrawWalkInSvgTitle">{title || 'Walk In the City'}</title>
			)}
			<defs>
				<linearGradient
				...
				<linearGradient
					...
					x2="520.07"
					y2="466.38"
					xlinkHref="#24f03e8c-5c7e-4fae-8483-b5d808403054"
				/>
				<linearGradient
			...
			/>
			<g opacity="0.1">
				<circle cx="421.4" cy="134.63" r="15.96" />
			</g>
