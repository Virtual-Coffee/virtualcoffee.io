...
the membership pipeline and the four submission tables with deterministic
Faker output, nulls Better Auth's OAuth secrets, deletes session/verification/
invite-token rows, and repoints any CoC attachment at one shared placeholder
