CREATE TYPE "public"."submission_event_type" AS ENUM('submitted', 'status_changed', 'note', 'notification_sent', 'notification_failed', 'imported');CREATE TYPE "public"."submission_status" AS ENUM('new', 'in_progress', 'resolved', 'dismissed');CREATE TABLE "coc_report" (
...
ALTER TABLE "submission_event" ADD CONSTRAINT "submission_event_coc_report_id_coc_report_id_fk" FOREIGN KEY ("coc_report_id") REFERENCES "public"."coc_report"("id") ON DELETE cascade ON UPDATE no action;ALTER TABLE "submission_event" ADD CONSTRAINT "submission_event_volunteer_signup_id_volunteer_signup_id_fk" FOREIGN KEY ("volunteer_signup_id") REFERENCES "public"."volunteer_signup"("id") ON DELETE cascade ON UPDATE no action;ALTER TABLE "submission_event" ADD CONSTRAINT "submission_event_lunch_and_learn_idea_id_lunch_and_learn_idea_id_fk" FOREIGN KEY ("lunch_and_learn_idea_id") REFERENCES "public"."lunch_and_learn_idea"("id") ON DELETE cascade ON UPDATE no action;ALTER TABLE "submission_event" ADD CONSTRAINT "submission_event_coffee_table_group_request_id_coffee_table_group_request_id_fk" FOREIGN KEY ("coffee_table_group_request_id") REFERENCES "public"."coffee_table_group_request"("id") ON DELETE cascade ON UPDATE no action;ALTER TABLE "submission_event" ADD CONSTRAINT "submission_event_actor_user_id_user_id_fk" FOREIGN KEY ("actor_user_id") REFERENCES "public"."user"("id") ON DELETE set null ON UPDATE no action;CREATE INDEX "coc_report_status_idx" ON "coc_report" USING btree ("status");CREATE INDEX "coc_report_submitted_at_idx" ON "coc_report" USING btree ("submitted_at");CREATE INDEX "coffee_table_group_request_status_idx" ON "coffee_table_group_request" USING btree ("status");CREATE INDEX "coffee_table_group_request_submitted_at_idx" ON "coffee_table_group_request" USING btree ("submitted_at");CREATE INDEX "lunch_and_learn_idea_status_idx" ON "lunch_and_learn_idea" USING btree ("status");CREATE INDEX "lunch_and_learn_idea_submitted_at_idx" ON "lunch_and_learn_idea" USING btree ("submitted_at");CREATE INDEX "submission_event_coc_report_id_idx" ON "submission_event" USING btree ("coc_report_id");CREATE INDEX "submission_event_volunteer_signup_id_idx" ON "submission_event" USING btree ("volunteer_signup_id");CREATE INDEX "submission_event_lunch_and_learn_idea_id_idx" ON "submission_event" USING btree ("lunch_and_learn_idea_id");CREATE INDEX "submission_event_coffee_table_group_request_id_idx" ON "submission_event" USING btree ("coffee_table_group_request_id");CREATE INDEX "volunteer_signup_status_idx" ON "volunteer_signup" USING btree ("status");CREATE INDEX "volunteer_signup_submitted_at_idx" ON "volunteer_signup" USING btree ("submitted_at");