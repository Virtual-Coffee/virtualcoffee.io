...
export const lauralangdon: MemberObject = {
	...
	// bio: `I'm a Technical Writer and math lecturer specializing in data science and AI ethics.`,
	//
	// Links - You can add one of each type, except website - you can add as many `website` accounts as you wish.
	accounts: [
		// { type: 'linkedin', username: 'laura-langdon' },
		// { type: 'dev', username: 'yourUserName' },
		// { type: 'codenewbie', username: 'yourUserName' },
		// { type: 'twitter', username: 'laura_e_langdon' },
		// { type: 'twitch', username: 'yourUserName' },
		// { type: 'youtube', channelId: 'yourChannelId' }, OR { type: 'youtube', customUrl: 'https://www.youtube.com/c/yourCustomUrl' },
		// { type: 'polywork', username: 'lauralangdon' },
