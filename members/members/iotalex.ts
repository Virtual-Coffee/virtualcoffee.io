...
export const iotalex: MemberObject = {
	...
	bio: `Full Stack Software Developer | JavaScript, React, Node.js, .NET, C#`,
	//
	...
	accounts: [
		{ type: 'linkedin', username: 'iotalex' },
		// { type: 'dev', username: 'yourUserName' },
		// { type: 'codenewbie', username: 'yourUserName' },
		{ type: 'twitter', username: '1oTAlex' },
