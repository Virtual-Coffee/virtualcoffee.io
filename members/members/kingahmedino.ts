...
export const kingahmedino: MemberObject = {
	...
	bio: `Google certified Android Developer now working around building scalable solutions across Mobile and Web 3.0 technologies`,
	//
	...
	accounts: [
		{ type: 'linkedin', username: 'ahmed-me' },
		// { type: 'dev', username: 'yourUserName' },
		// { type: 'codenewbie', username: 'yourUserName' },
		{ type: 'twitter', username: 'kingahmedino' },
		// { type: 'twitch', username: 'yourUserName' },
		// { type: 'youtube', channelId: 'yourChannelId' }, OR { type: 'youtube', customUrl: 'https://www.youtube.com/c/yourCustomUrl' },
		// { type: 'polywork', username: 'yourUserName' },
		// { type: 'medium', username: 'yourUserName' },
		{ type: 'hashnode', username: 'kingahmedino' },
