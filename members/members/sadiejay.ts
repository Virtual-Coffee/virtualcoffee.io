...
export const sadiejay: MemberObject = {
	...
	bio: `Front-end web developer with a background in psychology, art and digital communication.`,
	...
	accounts: [
		...
		{
			type: 'website',
			url: 'https://www.sadiejay.codes/',
			title: 'Sadie Jay Portfolio Site',
		},
	],
