...
export const ridonky: MemberObject = {
	...
	bio: `Software engineer and recovering product manager | Runner | Dogmom`,
	//
	...
	accounts: [
		...
		{ type: 'twitter', username: 'laurenperini' },
		// { type: 'twitch', username: 'yourUserName' },
		// { type: 'youtube', channelId: 'yourChannelId' }, OR { type: 'youtube', customUrl: 'https://www.youtube.com/c/yourCustomUrl' },
		// { type: 'polywork', username: 'yourUserName' },
		{ type: 'medium', username: 'lauren.perini' },
		// { type: 'hashnode', username: 'yourUserName' },
		{ type: 'website', url: 'https://ridonky.github.io/', title: 'Portfolio' },
	],
