...
export const TammyMiller: MemberObject = {
	...
	bio: `A manual software tester, Python enthuiast, blogger, Python teacher, and accessibility advocate.`,
	//
	...
	accounts: [
		...
		{ type: 'twitter', username: 'dctechsista' },
