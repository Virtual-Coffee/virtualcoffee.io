...
export const rmirville: MemberObject = {
	...
	bio: `he/him | U.S. Web developer working with Angular, C#, and accessibility | Prone to pun purveyance and wordplay wizardry`,
	//
	...
	accounts: [
		{ type: 'linkedin', username: 'raynaldm' },
		// { type: 'dev', username: 'yourUserName' },
		// { type: 'codenewbie', username: 'yourUserName' },
		{ type: 'twitter', username: 'rainalldaylong' },
		// { type: 'twitch', username: 'yourUserName' },
		// { type: 'youtube', channelId: 'yourChannelId' }, OR { type: 'youtube', customUrl: 'https://www.youtube.com/c/yourCustomUrl' },
		// { type: 'polywork', username: 'yourUserName' },
		// { type: 'medium', username: 'yourUserName' },
		// { type: 'hashnode', username: 'yourUserName' },
		{ type: 'website', url: 'https://raynaldmirville.com', title: 'Portfolio' },
	],
