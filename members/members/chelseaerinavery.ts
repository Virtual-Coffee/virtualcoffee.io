...
export const chelseaerinavery: MemberObject = {
	// GitHub username (required)
	github: 'chelseaerinavery',
	bio: 'Full Stack Software Developer | Medical Speech-Language Pathologist | Technology with Integrity ✨',
	//
	...
	accounts: [
		{ type: 'linkedin', username: 'chelseaavery' },
		// { type: 'dev', username: 'yourUserName' },
		// { type: 'codenewbie', username: 'yourUserName' },
		{ type: 'twitter', username: 'chelseaavery_' },
